...
class Student(models.Model):
    #id = models.AutoField(primary_key = True)
    student_name = models.CharField(max_length=100, help_text='Name of Author', null=True)
    # book_name = models.ForeignKey('Book',on_delete=models.SET_NULL, help_text='Book Took', null=True)
    ...
    num_of_books = models.CharField(max_length=1, choices=numChoice, blank=True) 
